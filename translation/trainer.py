...
class DOT_Trainer(nn.Module):
    ...
    def gen_backward_cc(self, x_a, x_b, hyperparameters):
        ...
        # self.loss_gen_geo_x_a = self.loss_gen_geo_x_a + self.geometry_kl_criterion(x_ab, x_a, hyperparameters['geo_kl_w']) # Found it works too
        ...
        # self.loss_gen_geo_x_b = self.loss_gen_geo_x_b + self.geometry_kl_criterion(x_ba, x_b, hyperparameters['geo_kl_w']) # Found it works too
